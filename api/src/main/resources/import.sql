INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Laura Lopes Rodriguez','https://i.imgur.com/QilXedT.jpg', 'Scrum Master' , '10 Anos atuando como Scrum Master, com passagens por diversas empresas, desde startups a big techs.', 'Senior','Tokyo', 'lauralr@fcamara.com', 'São Paulo-SP');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Maria Joaquina Pirlo','https://i.imgur.com/3bHBC9H.jpg', 'Desenvolvedora Fullstack', 'Determinação e coragem são as palavras que mais me descrevem. Comecei a estudar programação sozinha e fui me aperfeiçoando ao longo dos anos de maneira autodidata, tenho muito conhecimento a oferecer, principalmente se estamos falando de Java e Backend.','Pleno','Tokyo', 'mariajp@fcamara.com', 'Belo Horizonte-MG');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Roberto Siqueira Totti','https://i.imgur.com/QANNp6F.jpg', 'UX-Designer', 'Sou apaixonado por Design e psicologia e adoro expor minha criatividade, essas habilidades me levaram naturalmente ao caminho do UX a qual me dedico todos os dias','Pleno','Tokyo', 'robertost@fcamara.com', 'São Paulo-SP');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'João Roberto Marinho','https://i.imgur.com/P1plcar.jpg','Tech Lead','Atuei em diversas empresas ao longo dos meus 6 anos de carreira, acredito que a motivação e estudo encurtam qualquer distância entre uma pessoa e o domínio técnico de algo.','Senior', 'Tokyo', 'joaorm@fcamara.com', 'Londres-Inglaterra');

INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Leila Joana Cannavaro','https://i.imgur.com/hUlZzld.jpg', 'Desenvolvedora FullStack', 'Construi dezenas de aplicações fullstack, iniciei como programadora aos 12 anos por esporte e continuo até hoje, dominando a Stack node e Angular. ','Pleno','Jamaica', 'leilajc@fcamara.com', 'Kiev-Ucrânia');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Marcelo Roberto Buffon','https://i.imgur.com/VKd3xYu.jpg', 'Scrum Master', 'Palestrante do TED Talks, inimigo da moleza e parceiro da Agilidade. Transformei diversas empresas preguiçosas em exemplos de agilidade. ','Senior','Jamaica', 'marcelorb@fcamara.com', 'São Paulo-SP');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Paola Fernandes Gatuzzo','https://i.imgur.com/eGju6uI.jpg', 'Arquiteto de Software', 'Começar na programação pode ser muito complicado, mas tudo bem pedir ajuda a mim. Sou formada na USP em ciências da computação, construí minha carreira em diversos desafios que abrangem desde um sistema bancário imenso até IOT','Senior','Jamaica', 'paolafg@fcamara.com', 'Campinas-SP');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Miguel Silva Zambrotta','https://i.imgur.com/ZtqAinG.jpg', 'UX-Design', 'Entender o que o usuário quer e precisa é minha maior motivação, ainda sou iniciante e com um longo caminho pela frente mas posso compartilhar o que eu sei! ','Junior','Jamaica', 'miguelsz@fcamara.com', 'Jacarezinho-RJ');

INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao, senha) VALUES ( 'Lucas Silva Trevizan','https://i.imgur.com/coE5MjB.jpg', 'Desenvolvedor Fullstack', 'Me considero um autodidata nato e sou extremamente persistente nos meus objetivos, o que me torna ideal para o papel de desenvolvedor. Consigo conversar com leveza e transmitir bem meus conhecimentos, então se precisar de ajuda é só pedir.','Pleno','Italia', 'lucasst@fcamara.com', 'São Paulo-SP','1234');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Maria Roberta Dybala','https://i.imgur.com/KXdZ9Gu.jpg', 'Engenheira de Software', 'Mais de 10 anos sendo uma #sangueLaranja, sempre disposta a oferecer ajuda.','Senior','Italia', 'mariard@fcamara.com', 'Berlim-Alemanha');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Mariana Ribeiro Ibrahimović','https://i.imgur.com/YRERiyZ.jpg', 'UX-Designer', 'Provavelmente você já usou alguma tela que eu desenhei.','Pleno','Italia', 'marianari@fcamara.com', 'Transilvânia-Romenia');
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Beatriz Marauara Berbatov','https://i.imgur.com/n5o8EDK.jpg', 'Agilista', 'Inspirar pessoas a se tornarem ágil é minha maior missão','Junior','Italia', 'beatrizmb@fcamara.com', 'Milão-Italia');
...
INSERT INTO hard_skills (primeira_skill, nivel_primeira_hard, segunda_skill, nivel_segunda_hard, terceira_skill, nivel_terceira_hard, quarta_skill, nivel_quarta_hard, quinta_skill,  nivel_quinta_hard) VALUES ('Jira', 2, 'TFS', 3, 'Slack', 1, 'Asana', 3, 'Trello', 2)
...
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Ricardo da Luz','https://i.imgur.com/K07Be88.jpg','Ux Designer','Mais de 10 anos de experiência trabalhando com produtos digitais, identidades visuais e ecommerce. Estou a disposição!','Sênior', 'Rio', 'ricardoluz@fcamara.com', 'Guanabara-RJ');
...
INSERT INTO hard_skills (primeira_skill, nivel_primeira_hard, segunda_skill, nivel_segunda_hard, terceira_skill, nivel_terceira_hard, quarta_skill, nivel_quarta_hard, quinta_skill,  nivel_quinta_hard) VALUES ('Figma',2, 'Inglês', 3, 'Sketch', 2, 'Adobe Illustrator', 1, 'ProtoPie', 2)
...
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Luana Melo','https://i.imgur.com/tWzEf5O.jpg','Ui Designer','Estudante de desenvolvimento de sistemas, designer autônoma e apaixonada por UX e UI, essa é minha definição atual.','Júnior', 'Rio', 'lumelo@fcamara.com', 'São Paulo-SP');
...
INSERT INTO hard_skills (primeira_skill, nivel_primeira_hard, segunda_skill, nivel_segunda_hard, terceira_skill, nivel_terceira_hard, quarta_skill, nivel_quarta_hard, quinta_skill,  nivel_quinta_hard) VALUES ('Adobe XD', 1, 'Invision Studio', 2, 'Sketch', 3, 'Balsamiq', 1, 'Marvel', 2)
...
INSERT INTO usuario (nome, link_foto, profissao_atual, resumo, nivel_senioridade, squad, email, localizacao) VALUES ( 'Pablo Galvão','https://i.imgur.com/8iFPLgP.jpg','Ux/Ui Designer','Fui conquistado pelo lado pessoal e humano da tecnologia ao utilizar métodos de design centrados no usuário.Minha missão diária é orientar às pessoas em todos os desafios do negócio.','Sênior', 'Veneza', 'pablogalvao@fcamara.com', 'Texas-EUA');
...
INSERT INTO hard_skills (primeira_skill, nivel_primeira_hard, segunda_skill, nivel_segunda_hard, terceira_skill, nivel_terceira_hard, quarta_skill, nivel_quarta_hard, quinta_skill,  nivel_quinta_hard) VALUES ('Figma', 3, 'Sass', 2, 'HTML', 1, 'CSS', 1, 'Desinion', 1)
